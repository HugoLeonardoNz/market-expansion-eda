"""
Tema unico dos graficos da analise de expansao.
...
e nenhuma folga entre o titulo e o topo da area de plotagem. Seis graficos, seis
acabamentos.
...
def save(fig: go.Figure, outdir: Path, name: str, png: bool = False,
    ...
    `include_plotlyjs="cdn"` mantem cada HTML em ~15 KB em vez de ~4 MB — seis
